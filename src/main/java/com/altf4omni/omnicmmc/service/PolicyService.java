...
public class PolicyService {
    public ResponseEntity<ByteArrayResource> createPolicyList(AnswerRequestDto answerRequestDto) throws DocumentException, IOException {
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will limit information system access to: Identified, authorized users, processes" +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will limit information system access to the types of transactions and functions " +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will identify, verify, and control/limit connections to and use of external information systems."));
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will control information posted or processed on publicly accessible information " +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will identify information system users, processes acting on behalf of users, and devices."));
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will authenticate (or verify) the identities of those users, processes acting on behalf of users," +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will sanitize or destroy information system media containing Federal Contract Information before " +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will limit physical access to organizational information systems, equipment," +
                " and the respective operating environments to authorized individuals."));

        //PE.L1-3.10.3 – ESCORT VISITORS
        policyDocument.add(new Paragraph("PE.L1-3.10.1 – LIMIT PHYSICAL ACCESS", new Font(Font.FontFamily.TIMES_ROMAN, 16, Font.BOLD|Font.UNDERLINE)));
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will escort visitors and monitor visitor activity."));
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will maintain audit logs of physical access."));

        //PE.L1-3.10.5 – MANAGE PHYSICAL ACCESS
        policyDocument.add(new Paragraph("PE.L1-3.10.4 – PHYSICAL ACCESS LOGS", new Font(Font.FontFamily.TIMES_ROMAN, 16, Font.BOLD|Font.UNDERLINE)));
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will identify, control and manage physical access devices."));
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will monitor, control, and protect organizational communications (i.e., " +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will implement subnetworks for publicly accessible system components that are physically " +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will identify, report, and correct information and information system flaws in a timely manner." +
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will provide protection from malicious code at appropriately designated locations within the organizational information systems."));
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will update malicious code protection mechanisms when new releases are available."));
        ...
        policyDocument.add(new Paragraph(answerRequestDto.getCompanyName() + " will perform periodic scans of the information system and real-time scans of files from external " +
