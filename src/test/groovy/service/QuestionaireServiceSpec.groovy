...
class QuestionaireServiceSpec extends Specification {
    ...
    def questionaireQuestionRepository = Mock(QuestionRepository)
    def questionaireExtendedQuestionRepository = Mock(ExtendedQuestionRepository)
    def sut = new QuestionaireService(questionaireSectionRepository, questionaireQuestionRepository, questionaireExtendedQuestionRepository)
    ...
    def "getQuestionnaire is successful"() {
        ...
        response.sections[0].questions[0].questionID == 1
        ...
        1 * questionaireSectionRepository.findAll() >> [new QuestionSection(1, 'Hello World',
                ...
                , [new ExtendedQuestion(1, "Hello World extended", "Bye World extended", 1,1)], 1)])]
        0 * _
    }
    ...
    def "Should not return npe if a question does not have extended quesitons"() {
        ...
        1 * questionaireSectionRepository.findAll() >> [
                ...
                1, [
                        new Question(1, "Hello World", "Bye World", 1, Boolean.TRUE,[], 1)])
                 ]
        0 * _
    }
